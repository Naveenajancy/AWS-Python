"""
Django settings for sqs_quickstart project.
...
SECRET_KEY = 'django-insecure-6=wubv@)5i_x(y+q@7*f_5x6#!be0ttcyfo9tjkm1f_(&b@)bp'
...
ROOT_URLCONF = 'sqs_quickstart.urls'
...
WSGI_APPLICATION = 'sqs_quickstart.wsgi.application'
